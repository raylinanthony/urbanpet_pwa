...
(function($) {
 ...
 $(_menu).on('click', function(e) {
 	...
 	let targetSection = $(this).attr('href'), arrHides = [];
    ...
    const getBreedData = (_breed) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            $(_breedPropsSection + ' .breed_img').attr('src', _breed.img);
    ...
    const pwaLoadData = () => {
        ...
        return fetch(pwaConfig).then(data => data.json());
